    ...
    <div id="skills" className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="md:col-span-2 bg-card border border-border p-6 rounded-2xl flex flex-col justify-between hover:bg-card/80 transition-colors relative overflow-hidden group"
        >
        ...
        <motion.div
          ...
          className="md:col-span-2 md:row-span-2 bg-gradient-to-br from-card to-background border border-border p-6 rounded-2xl flex flex-col hover:border-primary/40 transition-all relative"
        >
        ...
        <motion.div
          ...
          className="md:col-span-2 bg-card border border-border p-6 rounded-2xl flex flex-col hover:bg-card/80 transition-colors group"
        >
        ...
        <motion.div
          ...
          className="bg-card border border-border p-5 rounded-2xl flex flex-col items-center justify-center text-center hover:bg-card/80 transition-colors"
        >
        ...
        <motion.div
          ...
          className="md:col-span-4 bg-primary text-primary-foreground p-6 rounded-2xl flex flex-wrap items-center justify-between relative overflow-hidden"
        >
          <div className="z-10">
