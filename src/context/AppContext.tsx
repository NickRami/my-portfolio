...
const translations = {
  en: {
    ...
    'hero.title.start': 'Architecting ',
    'hero.title.highlight': 'High-Performance Systems',
    'hero.title.end': ' for a Digital-First World.',
  ...
  es: {
    ...
    'hero.title.start': 'Diseñando ',
    'hero.title.highlight': 'Arquitecturas Digitales',
    'hero.title.end': ' de Siguiente Generación.',
